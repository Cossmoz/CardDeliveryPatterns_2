...
public class DataGenerator {
    ...
    public static class AddUser {
        ...
        public static Registration addValidUser() {
            Registration user = new Registration(getLogin(), getPassword(), "active");
            registerUser(user);
            return user;
        }

        public static Registration addNotValidUserLogin() {
        ...
        public static Registration addNotValidUserPassword() {
        ...
        public static Registration addNotRegisteredUser() {
            Registration user = new Registration(getLogin(), getPassword(), "active");
            return user;
        }

        public static Registration addBlockedUser() {
